...
/**
 * Exception class to handle computation-related failures. 
 * This exception is thrown for an issue with the computation proccess, 
 * such as invalid input, processing failures, or output storage errors. 
 */
