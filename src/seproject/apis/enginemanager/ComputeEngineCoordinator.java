...
public class ComputeEngineCoordinator {
	...
	/*
	 * Method to start computation process. Receives input location, processes the
	 * computation, and writes results
	 * 
	 * @param inputSource --> source location for input data
	 * 
	 * @param outputDest --> where the results of the computation will be sent to
	 * upon completion
	 * 
	...
	public String startComputation(String inputSource, String outputDest, char delimiter) throws ComputationException {
		try {
			...
			// step 5 --> request/confirm that the results have been successfully written to
